;ml64 /c SalemAlem.asm
;link /subsystem:console SalemAlem.obj MyLib-64.obj /ENTRY:main /largeaddressaware:no

;ml64 SalemAlem.asm /link /subsystem:console SalemAlem.obj /ENTRY:main /largeaddressaware:no
