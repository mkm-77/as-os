;ml64 /Strtrim.asm
;link /subsystem:console Trim.obj kernel32.Lib MyLib-64.obj /ENTRY:main /largeaddressaware:no

;ml64 Trim.asm /link /subsystem:console Trim.obj MyLib-64.obj /ENTRY:main /largeaddressaware:no
