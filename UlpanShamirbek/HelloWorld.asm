...
;link /subsystem:console HelloWorld.obj MyLib-64.obj /ENTRY:main /largeaddressaware:no

;ml64 HelloWorld.asm /link /subsystem:console HelloWorld.obj /ENTRY:main /largeaddressaware:no
