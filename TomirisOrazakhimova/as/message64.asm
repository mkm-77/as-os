;ml64 /c message64.asm
;link /subsystem:console message64.obj MyLib-64.obj /ENTRY:main /largeaddressaware:no

;ml64 message64.asm /link /subsystem:console message64.obj MyLib-64.obj /ENTRY:main /largeaddressaware:no
