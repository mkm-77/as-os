;ml64 uppercase.asm /link /subsystem:console uppercase.obj MyLib-64.obj /ENTRY:main /largeaddressaware:no


;ml64 /c uppercase.asm
;link /subsystem:console uppercase.obj MyLib-64.obj /ENTRY:main /largeaddressaware:no
