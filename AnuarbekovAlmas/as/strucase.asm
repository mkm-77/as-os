;ml64 strucase.asm /link /subsystem:console strucase.obj MyLib-64.obj /ENTRY:main /largeaddressaware:no

;ml64 /c strucase.asm
;link /subsystem:console strucase.obj kernel32.Lib MyLib-64.obj /ENTRY:main /largeaddressaware:no
